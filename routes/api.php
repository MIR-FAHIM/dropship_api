...
Route::post('/auth/login-as-vendor', [AuthController::class, 'loginAsVendor']);
Route::post('/auth/forgot-password', [AuthController::class, 'forgotPassword'])->withoutMiddleware('token');
Route::post('/auth/reset-password', [AuthController::class, 'resetPassword'])->withoutMiddleware('token');
...
Route::prefix('products')->group(function () {
    ...
    Route::get('/list-home-product', [ProductController::class, 'listHomeProducts'])->withoutMiddleware('token');
...
Route::prefix('delivery-companies')->group(function () {
    ...
    Route::get('/carrybee/order-drafts/{id}', [DeliveryCompanyController::class, 'orderDraftDetails']);
    Route::put('/carrybee/order-drafts/{id}', [DeliveryCompanyController::class, 'orderDraftUpdate']);
    Route::delete('/carrybee/order-drafts/{id}', [DeliveryCompanyController::class, 'orderDraftDelete']);
});
